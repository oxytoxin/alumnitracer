<div x-data>
    ...
    <div>
        @if ($personal_information)
            <div x-ref="resume" class="border-slate-900 dark:border-white dark:divide-white border-2 mt-4 print:mt-0 flex divide-x-2 divide-black">
                <div class="p-8 print:p-2 w-2/5 flex flex-col">
                    <div class="flex-1">
                        ...
                        <div class="mt-4">
                            <p class="prose text-xs italic dark:text-white indent-4 text-justify whitespace-pre-line">{{ $personal_information->bio }}</p>
                        </div>
                            ...
                            @forelse ($personal_information->educational_background as $educational_background)
                                <li class="p-2 border-2 border-primary rounded-lg">
                                    ...
                                    @isset($educational_background->other_details['remarks'])
                                        <p class="dark:text-white prose flex items-center gap-2 text-sm italic">
